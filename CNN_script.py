...
def main():
    ...
    ap.add_argument("--standardize", action="store_true",
                    help="Channel-wise z-score for image inputs; for PCA+logreg, feature-wise z-score.")
    ap.add_argument("--pca", type=str, default="0",
                    help="Only for logreg. 0=off; float in (0,1] is variance target (e.g., 0.95); int >=1 is #components.")
    args = ap.parse_args()
