...
SBATCH_FILE = os.path.join(BASE_DIR, "mcfost_vr.sbatch")
...
for i, line in enumerate(lines):
    ...
    try:
        ...
        shutil.copy(SBATCH_FILE, "mcfost_vr.sbatch")

        # Submit job using sbatch
        subprocess.run("sbatch mcfost_vr.sbatch", shell=True, check=True)
